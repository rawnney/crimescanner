...
export default class UserSettingsContainer extends PureComponent<Props, State> {
  ...
  toggle = (isDarkMode: boolean) => Store.dispatch(Actions.changeAppState({colorTheme: !isDarkMode}))
}
